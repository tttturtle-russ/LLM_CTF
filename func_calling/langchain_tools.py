...
class RunCommand(BaseTool):
    ...
    def start_docker(self):
        ...
        print(
            f"Exec docker run {' '.join(volumes)} --network {self.namespace.network} --platform linux/amd64 -d --rm --name {self.namespace.container_name} {self.namespace.container_image}")
