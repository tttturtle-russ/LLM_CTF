...
#    python main.py --question="$chal" --model="$1" --prompt="./prompts/prompts_open/rev/$base_chal".txt > "./logging/rev/$base_chal".txt
    python main.py --question="$chal" --model="$1" > "./logging/rev/$base_chal".txt
done